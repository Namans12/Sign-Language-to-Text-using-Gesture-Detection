...
import torch
from keytotext.trainer import trainer
from keytotext.make_dataset import make_dataset
...
def nlp(sentence):
    nlp2 = k2t_pipeline("mrm8488/t5-base-finetuned-common_gen")
